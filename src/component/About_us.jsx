    ...
    <div className="grid md:grid-cols-2 gap-8 lg:gap-12">
      <div>
        <div className="h-auto md:h-auto bg-gray-100 overflow-hidden rounded-lg shadow-lg">
          <img  src="https://images.unsplash.com/photo-1598079253422-638fa9b2d160?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=700&q=200" loading="lazy" alt="pitbull" className="w-full h-full object-cover object-center" />
        </div>
      </div>
