            ...
            <section className="max-w-xl mt-12 mx-auto px-4">
                ...
                <div className="mt-5">
                    <form 
                        ...
                        />
                        <button
                            className="w-full mt-3 px-5 py-3 rounded-md text-white bg-yellow-600 outline-none shadow-md focus:shadow-none focus:ring-2 ring-offset-2 ring-indigo-600 sm:mt-0 sm:ml-3 sm:w-auto"
                        >
                            Subscribe
                        </button>
                    </form>
