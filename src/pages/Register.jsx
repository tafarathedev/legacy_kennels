...
const Register = () => {
  ...
  const user_info = {
    ...
    /* //User Register functions and states */ 
    const [formData , setFormData] = React.useState(user_info)
...
/*  toast function */
    ...
    const errorNotify = ()=>toast.danger("sorry")
            ...
            className="mt-8 grid grid-cols-6 gap-6">
              ...
              <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                ...
                type="submit"
                  ...
                  className="inline-block shrink-0 rounded-md border border-blue-600 bg-yellow px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500 dark:hover:bg-blue-700 dark:hover:text-white"
                >
                  Create an account
                </button>
